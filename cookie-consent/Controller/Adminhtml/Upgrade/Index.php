...
namespace MiniOrange\CookieConsent\Controller\Adminhtml\Upgrade;

use MiniOrange\CookieConsent\Controller\Adminhtml\Index\Index as PrivacyIndex;

class Index extends PrivacyIndex
{
    public const ADMIN_RESOURCE = 'MiniOrange_CookieConsent::tab_upgrade';
    ...
    {
        $this->getRequest()->setParam('active_tab', 'upgrade');
